...
public class ControlRoomPowerMagnetismActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_control_room_magnetism);
        ...
        tv_cpName.setText("控制室电磁场强度检查记录单");
    ...
    protected int initContentView() {
        return R.layout.activity_control_room_magnetism;
    }
    ...
    private String mTmpSub = "TEMP-CONTROLROOMPOWERMAGNETISM";
    ...
    private void loadTmpfile() {
        ...
        try {
            ...
            if (result != null) {
                ...
                ((EditText) findViewById(R.id.f_gs_max)).setText(obj.getString("f_gs_max"));
                ((EditText) findViewById(R.id.r_gs_max)).setText(obj.getString("r_gs_max"));
    ...
    private void Clearall() {
        ...
        ((EditText) findViewById(R.id.f_gs_max)).setText("");
        ((EditText) findViewById(R.id.r_gs_max)).setText("");
    ...
    private void setAdapter() {
        ...
        adapter.f_gs_max = ((EditText) findViewById(R.id.f_gs_max)).getText().toString().trim();
        adapter.r_gs_max = ((EditText) findViewById(R.id.r_gs_max)).getText().toString().trim();
    ...
    private static final String TAG_CAB = "CONTROLROOMPOWERMAGNETISM";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            break;
            case R.id.im_erase: {
                new AlertDialog.Builder(ControlRoomPowerMagnetismActivity.this).setTitle("系统提示")//设置对话框标题
