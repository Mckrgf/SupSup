...
public class SystemPowerCheckActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_system_power_check);
    ...
    protected int initContentView() {
        return R.layout.activity_system_power_check;
    }
    ...
    private String mTmpSub = "TEMP-SYSTEMPOWERCHECK";
    ...
    private void loadTmpfile() {
        ...
        try {
            ...
            if (result != null) {
                ...
                ((EditText) findViewById(R.id.control_cabinet )).setText(obj.getString("control_cabinet"  ));

                SetRGtext(R.id.has_normal       , obj.getString("has_normal"        ));
    ...
    private void Clearall() {
        ...
        ((EditText) findViewById(R.id.control_cabinet )).setText("");

        SetRGtext(R.id.has_normal       ,         "");
    ...
    private void setAdapter() {
        adapter.control_cabinet    = ((EditText) findViewById(R.id.control_cabinet    )).getText().toString().trim();

        adapter.has_normal       = GetRGtext(R.id.has_normal       );
    ...
    private static final String TAG_CAB = "SYSTEMPOWERCHECK";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            break;
            case R.id.im_erase: {
                new AlertDialog.Builder(SystemPowerCheckActivity.this).setTitle("系统提示")//设置对话框标题
