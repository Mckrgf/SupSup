...
public class PowerCheckActivity extends BaseActivity implements View.OnClickListener {

    private ImageView mivAdd;

    public PowerCheckAdapter adapter = new PowerCheckAdapter();
    ...
    protected int initContentView() {
        return R.layout.activity_power_check;
    }
    ...
    private String mTmpSub = "TEMP-POWERCHECK";
    ...
    private void loadTmpfile() {
        ...
        try {
            ...
            if (result != null) {
                ...
                ((EditText) findViewById(R.id.power_num )).setText(obj.getString("power_num"  ));
    ...
    private void Clearall() {
        ...
        ((EditText) findViewById(R.id.power_num )).setText("");
    ...
    private void setAdapter() {
        adapter.power_num    = ((EditText) findViewById(R.id.power_num    )).getText().toString().trim();
    ...
    private static final String TAG_CAB = "POWERCHECK";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            break;
            case R.id.im_erase: {
                new AlertDialog.Builder(PowerCheckActivity.this).setTitle("系统提示")//设置对话框标题
