...
public class MasterCardCheckActivity extends BaseActivity implements View.OnClickListener {

    private ImageView mivAdd;

    public MasterCardCheckAdapter adapter = new MasterCardCheckAdapter();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_master_card_check);
    ...
    protected int initContentView() {
        return R.layout.activity_master_card_check;
    }
    ...
    private String mTmpSub = "TEMP-MASTERCARDCHECK";
    ...
    private void Clearall() {
        ...
        SetRGtext(R.id.has_identified  ,         "");
        SetRGtext(R.id.has_subs_zero   ,         "");
        SetRGtext(R.id.has_subs_one    ,         "");
    ...
    private void setAdapter() {
        ...
        adapter.has_identified   = GetRGtext(R.id.has_identified  );
        adapter.has_subs_zero    = GetRGtext(R.id.has_subs_zero   );
        adapter.has_subs_one     = GetRGtext(R.id.has_subs_one    );
    ...
    private static final String TAG_CAB = "MASTERCARDCHECK";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            break;
            case R.id.im_erase: {
                new AlertDialog.Builder(MasterCardCheckActivity.this).setTitle("系统提示")//设置对话框标题
