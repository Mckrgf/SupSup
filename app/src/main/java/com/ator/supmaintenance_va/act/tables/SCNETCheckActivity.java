...
public class SCNETCheckActivity extends BaseActivity implements View.OnClickListener {

    private ImageView mivAdd;

    public SCNETCheckAdapter adapter = new SCNETCheckAdapter();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scnet_check);
        ...
        tv_cpName.setText("SCNET控制网冗余检查");
    ...
    protected int initContentView() {
        return R.layout.activity_scnet_check;
    }
    ...
    private String mTmpSub = "TEMP-SCNETCHECK";
    ...
    private void loadTmpfile() {
        ...
        try {
            ...
            if (result != null) {
                ...
                ((EditText) findViewById(R.id.address_one )).setText(obj.getString("address_one"  ));
                ((EditText) findViewById(R.id.address_two )).setText(obj.getString("address_two"  ));

                SetRGtext(R.id.has_normal_one       , obj.getString("has_normal_one"        ));
                SetRGtext(R.id.has_normal_two       , obj.getString("has_normal_two"        ));
    ...
    private void Clearall() {
        ...
        ((EditText) findViewById(R.id.address_one )).setText("");
        ((EditText) findViewById(R.id.address_two )).setText("");

        SetRGtext(R.id.has_normal_one       ,         "");
        SetRGtext(R.id.has_normal_two       ,         "");
    ...
    private void setAdapter() {
        adapter.address_one    = ((EditText) findViewById(R.id.address_one    )).getText().toString().trim();
        adapter.address_two    = ((EditText) findViewById(R.id.address_two    )).getText().toString().trim();

        adapter.has_normal_one       = GetRGtext(R.id.has_normal_one       );
        adapter.has_normal_two       = GetRGtext(R.id.has_normal_two       );
    ...
    private static final String TAG_CAB = "SCNETCHECK";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            break;
            case R.id.im_erase: {
                new AlertDialog.Builder(SCNETCheckActivity.this).setTitle("系统提示")//设置对话框标题
